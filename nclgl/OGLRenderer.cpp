...
void OGLRenderer::SetShaderLight(const Light &l/*, const Light &l2*/) {
	...
	//test light2
	/*glUniform3fv(glGetUniformLocation(currentShader->GetProgram(), "lightPos2"), 1, (float*)&l2.GetPosition());
	glUniform4fv(glGetUniformLocation(currentShader->GetProgram(), "lightColour2"), 1, (float*)&l2.GetColour());
	glUniform1f(glGetUniformLocation(currentShader->GetProgram(), "lightRadius2"), l2.GetRadius());*/
}
