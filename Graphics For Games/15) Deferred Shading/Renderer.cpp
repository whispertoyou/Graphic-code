...
Renderer::Renderer(Window & parent) : OGLRenderer(parent) {
	...
	sceneShader = new Shader("../../Shaders/BumpVertex.glsl",
	...
	pointlightShader = new Shader("../../Shaders/pointlightvert.glsl",
		"../../Shaders/pointlightfrag.glsl");
...
void Renderer::FillBuffers() {
	...
	projMatrix = Matrix4::Perspective(1.0f, 50000.0f,
